...
const POSTS = [
  {
    ...
    excerpt: 'A complete breakdown of how African entrepreneurs are leveraging direct factory access to cut costs by up to 60%.',
    date: 'Feb 18, 2026',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt: 'Smart retailers are using China pre-orders to dominate local markets. Here\'s the exact playbook.',
    date: 'Feb 12, 2026',
    readTime: '4 min read',
  ...
  },
  {
    ...
    excerpt: 'From FOB pricing to customs clearance in Lagos — a plain-language guide to international freight.',
    date: 'Feb 5, 2026',
    readTime: '8 min read',
