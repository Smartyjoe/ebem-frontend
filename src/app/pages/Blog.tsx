...
const POSTS = [
  { id: 1, slug: 'china-manufacturing-guide', category: 'Sourcing', title: 'How Chinese Manufacturing Can Transform Your Business in Africa', excerpt: 'A complete breakdown of how African entrepreneurs are leveraging Ebem Global\'s direct factory access to cut product costs by up to 60%.', date: 'Feb 18, 2026', readTime: '6 min read', image: 'https://images.unsplash.com/photo-1611250396725-294c6af32fdd?w=800&q=80' },
  { id: 2, slug: 'pre-order-strategy', category: 'Trade', title: 'The Pre-Order Advantage: How to Get Products Before They Hit Nigerian Markets', excerpt: "Smart retailers are using Ebem Global's China pre-order channel to dominate local markets before stock even arrives. Here's the exact playbook.", date: 'Feb 12, 2026', readTime: '4 min read', image: 'https://images.unsplash.com/photo-1734255026082-82fdc81991f0?w=800&q=80' },
  { id: 3, slug: 'shipping-container-guide', category: 'Logistics', title: 'Container Shipping 101: Everything Nigerian Importers Need to Know', excerpt: 'From FOB pricing to customs clearance in Nigeria — a plain-language guide to international freight and how Ebem Global handles it for you.', date: 'Feb 5, 2026', readTime: '8 min read', image: 'https://images.unsplash.com/photo-1631349549824-fc1f8d971e3e?w=800&q=80' },
  { id: 4, slug: 'bulk-sourcing-guide', category: 'Bulk Orders', title: 'Why Bulk Sourcing from China is the Future for Nigerian Retailers', excerpt: "Retailers buying in bulk through Ebem Global are winning on margin, speed, and market share. Here's how to structure your first bulk order.", date: 'Jan 28, 2026', readTime: '5 min read', image: 'https://images.unsplash.com/photo-1674573071057-029f03b6add6?w=800&q=80' },
  { id: 5, slug: 'verified-suppliers', category: 'Suppliers', title: 'How Ebem Global Verifies Every Chinese Supplier Before Working with Them', excerpt: 'Not all factories are equal. Our structured verification process — factory checks, quality audits, compliance reviews — ensures you only get reliable sourcing.', date: 'Jan 20, 2026', readTime: '7 min read', image: 'https://images.unsplash.com/photo-1762343264418-1467f9394f49?w=800&q=80' },
  { id: 6, slug: 'africa-ecommerce-2026', category: 'Market', title: "Africa's Ecommerce Boom in 2026: What It Means for Importers", excerpt: "Nigeria's digital commerce is growing 30% year over year. Here's why China sourcing through Ebem Global is the smartest business move right now.", date: 'Jan 14, 2026', readTime: '5 min read', image: 'https://images.unsplash.com/photo-1744907895363-d351aa6019ef?w=800&q=80' },
];
